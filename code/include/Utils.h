...
namespace Utils{
    ...
    namespace Save{
        ...
        void save_metrics(const std::string& file_path, const float accuracy, const std::vector<float>& precision, const std::vector<float>& recall, const std::vector<float>& f1, const std::set<int>& classes_to_select);
    }
